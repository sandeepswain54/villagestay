...
class _UploadPropertyScreenState extends State<UploadPropertyScreen> {
  ...
  Future<List<String>> _uploadImages() async {
    ...
    for (int i = 0; i < _images.length; i++) {
      try {
        ...
        final ref = FirebaseStorage.instance.ref().child('hotel_images/$fileName');
        
        final uploadTask = ref.putFile(imageFile);
        uploadTask.snapshotEvents.listen((taskSnapshot) {
          setState(() {
            _uploadProgress = (i + taskSnapshot.bytesTransferred / taskSnapshot.totalBytes) / _images.length;
            _currentUploadPhase = "Uploading images (${i+1}/${_images.length})";
          });
        });
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final validatedSlots = _slots.map((slot) {
        return {
      ...
      await FirebaseFirestore.instance.collection('hotels').add(propertyData);
                          ...
                          children: [
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                onChanged: (value) => _slots[idx]['price'] = value,
                                validator: (value) {
                      ...
                      children: _amenities.asMap().entries.map((entry) {
                        ...
                        return FilterChip(
                          ...
                          onSelected: (bool value) {
                            setState(() => _selectedAmenities[idx] = value);
                          },
