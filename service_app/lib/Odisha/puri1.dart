...
class PuriHotelDetailScreen extends StatefulWidget {
  const PuriHotelDetailScreen({super.key});

  @override
  State<PuriHotelDetailScreen> createState() => _PuriHotelDetailScreenState();
}

class _PuriHotelDetailScreenState extends State<PuriHotelDetailScreen> {
