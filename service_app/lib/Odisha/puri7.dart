...
import 'package:service_app/Payment/payment_gateway.dart';
import 'package:url_launcher/url_launcher.dart';

class Puri7 extends StatefulWidget {
  const Puri7({super.key, required String hotelName, required List<String> images, required double rating, required String address, required List<String> amenities, required String description, required int reviewCount, required List<Map<String, String>> priceOptions});

  @override
  State<Puri7> createState() => _Puri7State();
}

class _Puri7State extends State<Puri7> 
{
...
SizedBox(
  ...
  child: ElevatedButton(
    ...
    onPressed: () async {
      ...
      await StripePayment.makePayment(100, 'INR'); // ₹100 test payment
    },
