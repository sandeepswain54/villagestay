...
class ToshaliSandsDetailScreen extends StatefulWidget {
  const ToshaliSandsDetailScreen({super.key});

  @override
  State<ToshaliSandsDetailScreen> createState() => _ToshaliSandsDetailScreenState();
}

class _ToshaliSandsDetailScreenState extends State<ToshaliSandsDetailScreen> {
