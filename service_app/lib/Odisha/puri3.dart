...
class SeaPearlHotelDetailScreen extends StatefulWidget {
  const SeaPearlHotelDetailScreen({super.key});

  @override
  State<SeaPearlHotelDetailScreen> createState() => _SeaPearlHotelDetailScreenState();
}

class _SeaPearlHotelDetailScreenState extends State<SeaPearlHotelDetailScreen> {
