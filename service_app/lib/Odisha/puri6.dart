...
class SterlingResortDetailScreen extends StatefulWidget {
  const SterlingResortDetailScreen({super.key});

  @override
  State<SterlingResortDetailScreen> createState() => _SterlingResortDetailScreenState();
}

class _SterlingResortDetailScreenState extends State<SterlingResortDetailScreen> {
