 ...
 final ScrollController _scrollController = ScrollController(); 
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Pochampally Village"),
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16),
                        Text(
                          "Bhoodan Pochampally Telangana 508284",
                          style: TextStyle(
                            fontSize: 14,
                          ),
                        ),
                        ...
                        GestureDetector(
                          onTap: () {
                            _launchMaps("Bhoodan Pochampally Telangana 508284");
                          },
                          child: Container(
                            height: 180,
                            decoration: BoxDecoration(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 16),
                        similarHotelCard(
                          name: "Pochampally Stay",
                          location: "Telangana",
                          acceptsLocalId: true,
                          payAtHotel: true,
                          prices: [1300, 1900, 2700],
                          imagePath: "assets/tel21.avif",
                          rating: 4.5,
                          reviews: 8,
                        ),
                        SizedBox(height: 24),
