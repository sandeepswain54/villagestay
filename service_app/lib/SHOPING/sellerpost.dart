...
// In your _buildProductDetailsStep() widget:
Widget _buildProductDetailsStep() {
  return SingleChildScrollView(
    ...
    child: Column(
      children: [
        const Text(
          "Your Products Will Appear Like This",
          style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
        ),
        const SizedBox(height: 20),
        
        // Example product card (similar to your reference image)
        Card(
          elevation: 3,
          child: Padding(
            padding: const EdgeInsets.all(12),
            child: Column(
              ...
              children: [
                ...
                // Product Details (like in your image)
                const Text("Base Type: B22"),
                const Text("Body Material: Aluminum"),
                const Text("Shape: Round"),
                const Text("Type: Aluminum LED Bulb"),
                
                const SizedBox(height: 10),
                
                // Business Info (like in your image)
                Row(
                  children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: _dressImage == null
                        ...
                        : Image.file(_dressImage!, fit: BoxFit.cover),
                  ),
                ),
              ],
            ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          const Text("Add up to 3 products you want to sell. You can add more later."),
          const SizedBox(height: 20),
          _buildProductAutocomplete("Product 1", product1Controller),
          const SizedBox(height: 10),
          _buildProductAutocomplete("Product 2", product2Controller),
          const SizedBox(height: 10),
          _buildProductAutocomplete("Product 3", product3Controller),
          const SizedBox(height: 50),
          ElevatedButton(
            onPressed: _nextPage,
            style: ElevatedButton.styleFrom(
